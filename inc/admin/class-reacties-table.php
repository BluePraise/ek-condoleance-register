...
class Reacties_Table extends Libraries\WP_List_Table  {
	...
	protected function get_views() {
		...
		// print_r(wp_count_comments( $post_id ));
		...
		$link = admin_url( 'edit.php?post_type=cpt_condolances&page=manage-reacties' );
		...
		foreach ( $stati as $status => $label ) {
			...
			$num_comments = $this->get_all_comments_of_post_type('cpt_condolances', $approval_status);
			...
			*/
			$status_links[ $status ] = "<a href='$link'$current_link_attributes>" . sprintf(
				translate_nooped_plural( $label, $num_comments ),
...
<?php
	 ...
	 * Get total comments
	 */
	public function get_all_comments_of_post_type($post_type, $status = null) {
		global $wpdb;
